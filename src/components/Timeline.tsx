...
const timelineData = [
  {
    ...
    subtitle: "The Next Big Idea :)",
    icon: ICONS.cog,
    items: [
      "Contacted by discuss opportunties.",
      "Helped team understand how software works with their idea.",
      "Implemented software to bring idea to life"
    ]
  },
  {
